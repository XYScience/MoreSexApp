 ...
 * @date 2015-1-28
 */
public class PhysiologyFragment extends Fragment implements OnRefreshListener,
	...
	public void onLoad() {
		mNextPage++;
		initData(AppConfig.GET_PHYSIOLOGY_JSON.replace("{1}", "" + mNextPage),
				3);
		new Handler().postDelayed(new Runnable() {
			@Override
			public void run() {
	...
	private void showArticleItem(Article articleEntry) {
		...
		mPath = AppConfig.GET_PHYSIOLOGY_JSON;
